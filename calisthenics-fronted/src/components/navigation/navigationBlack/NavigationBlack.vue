<template>
	<div class="navigation">
		<div class="row">
			<div class="navigation__logo col-3 offset-1">
				<label>calisthenics odense</label>
			</div>
			<div class="col-7">
...
<script src="./NavigationBlack.ts"></script>
<style lang="scss" src="./NavigationBlack.scss" scoped></style>
